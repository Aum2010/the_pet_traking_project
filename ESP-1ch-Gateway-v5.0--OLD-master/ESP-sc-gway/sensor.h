...
nodex nodes[] = {
	...
	{ 0x260B9D62 , "lora-00 well known sensor" }				// F=0
};
...
codex decodes[] = {
	...
	{ 0x260B9D62 , "lora-00",	// F=0
    { 0xD1, 0x02, 0x6C, 0xA8, 0xFB, 0x77, 0x09, 0x4C, 0xBE, 0xC0, 0xFF, 0x07, 0xDA, 0x2E, 0x18, 0xEF },
		{ 0xFA, 0x53, 0xE5, 0xE4, 0x95, 0x4E, 0xEB, 0xA2, 0x4A, 0x87, 0x12, 0x2F, 0xE8, 0x35, 0x93, 0xCD }
